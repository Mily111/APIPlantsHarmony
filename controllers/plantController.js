...
const { addOrUpdatePlantSuggestion } = require("../models/plantModel");
...
exports.addPlantSuggestion = async (req, res) => {
  ...
  try {
    await addOrUpdatePlantSuggestion({
      plantName,
      stateExchange,
      photo,
      userId,
...
// exports.addPlantSuggestion = async (req, res) => {
//   const { plantName, stateExchange, userId } = req.body;
//   const photo = req.file ? req.file.path : null; // Utilisez le chemin temporaire du fichier
