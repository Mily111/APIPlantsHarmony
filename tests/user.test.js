...
//     });
//     expect(res.statusCode).toEqual(400);
//     expect(res.body).toHaveProperty("message", '"email_user" is required');
//   });
...
//     });
//     expect(res.statusCode).toEqual(400);
//     expect(res.body).toHaveProperty("message", '"password_user" is required');
//   });
...
//     db.query.mockImplementationOnce(async (query, values) => {
//       if (query.includes("SELECT * FROM users WHERE username = ?")) {
//         return [
//           [
//             {
...
db.query.mockImplementation(async (query, values) => {
  if (query.includes("SELECT * FROM users WHERE username = ?")) {
    if (values.includes("existingUser")) {
      return [
        [
          {
            id: 1,
